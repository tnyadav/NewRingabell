...
import com.share2people.ringabell.R.xml;
...
public class SettingsActivity  extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		actionBar.setBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.settings_action_bar)));
	
		addPreferencesFromResource(R.xml.preferences);
		bindPreferenceSummaryToValue(findPreference("notifications_new_message_ringtone"));
		bindPreferenceSummaryToValue(findPreference("notifications_alarm_ringtone"));
		bindPreferenceSummaryToValue(findPreference("snooze_list"));
	}
